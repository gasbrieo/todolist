...
export const SocialButtons = () => {
  ...
  return (
    <div className="flex justify-center gap-2">
      <Button variant="outline" size="icon" aria-label="Sign in with Google" onClick={() => handleOAuthLogin("google")}>
        <svg
          viewBox="0 0 512 512"
      ...
      <Button variant="outline" size="icon" aria-label="Sign in with GitHub" onClick={() => handleOAuthLogin("github")}>
        <svg
          viewBox="0 0 640 640"
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
